function Pagination({ total }: { total: number }): JSX.Element {
  return (
    <nav
      className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
      aria-label="Table navigation"
    >
      <span className="text-sm font-normal text-gray-500 mr-0.5">
        Showing
        <span className="font-semibold text-gray-900 px-1">1-10</span>
        of
        <span className="font-semibold text-gray-900 px-1">{total}</span>
      </span>
      <ul className="inline-flex items-stretch -space-x-px">
        ...
        <li>
          <a
            href="#"
            className="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800"
          >
            2
          </a>
        </li>
