...
function Footer() {
  return (
    <footer
      className="w-full bg-dark-green text-white shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 z-[60]"
      data-cy="footer-container"
    >
      <p
        className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0"
        data-cy="footer-copy-reserved"
      >
        &copy; 2019-2023{' '}
        <Link to="/" className="hover:underline" target="_blank" data-cy="footer-home-link">
          Rent-a-car.com
        </Link>
        . All rights reserved.
      </p>
      <div className="flex justify-center items-center space-x-1" data-cy="footer-icon-links">
        <Link
          to="#"
